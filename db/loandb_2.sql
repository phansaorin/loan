...
--
-- Host: localhost
-- Generation Time: Oct 15, 2015 at 04:10 PM
...
`id` int(11) NOT NULL,
  `CID` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Group/individual',
  `first_name_english` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `last_name_english` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `nick_name_english` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `first_name_khmer` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `last_name_khmer` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `nick_name_khmer` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `gender` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `identity_card_passport` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `job` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `province` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `khan_district` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sangkat_commune` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `village` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `home_number` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `email` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `date_of_birth` datetime DEFAULT NULL,
  `marrital_status` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `account_type` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Group/individual'
...
(4, '0000004', 'sreychen', 'sok', 'chen', 'សៅរិន', 'ផាន', 'ចែរិន', 'Female', NULL, 'Web Designer', '170.000', '0972792211', 'BB', 'Traing', 'Khvav', 'Khvav', '0326363800', 'chhing@gmail.com', '1992-03-23 00:00:00', 'Single', NULL),
(5, '0000005', 'sreypich', 'chan', 'pich', 'សៅរិន', 'ផាន', 'ចែរិន', 'Female', NULL, 'Web Designer', '170.000', '0972792211', 'BB', 'Traing', 'Khvav', 'Khvav', '0326363800', 'chhing@gmail.com', '1992-03-23 00:00:00', 'Single', NULL),
(6, '0000006', 'sokea', 'sok', 'sikea', 'សៅរិន', 'ផាន', 'ចែរិន', 'Female', NULL, 'Web Designer', '170.000', '0972792211', 'BB', 'Traing', 'Khvav', 'Khvav', '0326363800', 'chhing@gmail.com', '1992-03-23 00:00:00', 'Single', NULL),
(7, '0000007', 'sreynak', 'chet', 'nak', 'សៅរិន', 'ផាន', 'ចែរិន', 'Female', NULL, 'Web Designer', '170.000', '0972792211', 'BB', 'Traing', 'Khvav', 'Khvav', '0326363800', 'chhing@gmail.com', '1992-03-23 00:00:00', 'Single', NULL),
(8, '0000008', 'borey', 'chan', NULL, NULL, NULL, NULL, 'Female', NULL, 'Bank', '170.000', '0972792211', 'BB', 'Traing', 'Khvav', 'Khvav', '0326363800', 'chhing@gmail.com', '1992-03-23 00:00:00', 'Single', NULL),
(9, '0000009', 'sila', 'chort', NULL, NULL, NULL, NULL, 'Male', NULL, 'Farmer', '170.000', '0972792211', 'BB', 'Traing', 'Khvav', 'Khvav', '0326363800', 'chhing@gmail.com', '1992-03-23 00:00:00', 'Single', NULL);
...
(5, '2015-10-06 00:00:00', '8888-00000006-8', 'pending', '1', 'year', 8, '10000 Riel - 1000000 Riel', 1, 'Anuilty', 'Single', 'Dolla', 1, 'monthly', '100000.000', 'test', '2015-10-07 00:00:00', 1, '2.000', '0.000', '100000.000', 0),
(6, '2015-10-06 00:00:00', '8888-00000007-9', 'pending', '1', 'year', 9, '10000 Riel - 1000000 Riel', 1, 'Anuilty', 'Single', 'KHR', 1, 'monthly', '200000.000', 'rew', '2015-10-07 00:00:00', 1, '3.000', '0.000', '200000.000', 0);
