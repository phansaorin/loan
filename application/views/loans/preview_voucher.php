	...
	<div class="pull-left logo col-3 border " style="width: 20px;">
      <div>
        <table cellspacing="0" cellpadding="1" border="1">
            ...
            <tr>
               <td>Loan Account: '.$loan_info->loan_account.'</td>
            </tr>
          ...
          <tr>
              <td>
                  <table cellspacing="0" cellpadding="1">
                    ...
                    <tr>
                        ...
                        <td border="1">'.$loan_info->loan_amount.' '.$currency.'</td>
                    </tr>
                    <tr>
                        <td>In Word :</td>
                        <td border="1">....</td>
              ...
              <td>
                  <table>
                      <tr>
                            <td>Payee :</td>
                            <td border="1" width="110" height="10">'.strtoupper($loan_info->last_name_english).' '.$loan_info->first_name_english.'</td>
                        </tr>
                        <tr>
                            <td>Gender :</td>
                            <td border="1">'.$loan_info->gender.'</td>
                        </tr>
                        <tr>
                            <td>Address :</td>
                            <td border="1" width="110" height="100">'.$loan_info->khan_district.', '.$loan_info->sangkat_commune.', '.$loan_info->village.', '.$loan_info->province.'</td>
                        </tr>
                        <tr>
                            <td>Fingerprint :</td>
